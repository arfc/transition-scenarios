...
plot_several('29-power0' + add + '1', all_dict, 'power', calc_methods1,
             demand_eq)
...
plot_several('29-power0' + add + '2', all_dict, 'power', calc_methods2,
             demand_eq)
...
plot_several('29-power0' + add + '3', all_dict, 'power', calc_methods3,
             demand_eq)
