...
#use of file: python create_input.py  2019 united_states
#asumes file name and location, input year of data and region to be used
...
deployment_path = '../input/haleu/inputs/' + region + '/buildtimes'
reactor_path = '../input/haleu/inputs/' + region + '/reactors'
...
import_data.render_cyclus(cyclus_tmpl, region, buildtime, '../input/haleu/inputs/',51) # change burn up 
